...
//! @brief Exception class for the Result::ErrorExtensionDependencyNotEnabled aka XR_ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED result code.
class ExtensionDependencyNotEnabledError : public SystemError {
   public:
    ExtensionDependencyNotEnabledError (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorExtensionDependencyNotEnabled), message){}

    ExtensionDependencyNotEnabledError (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorExtensionDependencyNotEnabled), message) {}
};


//! @brief Exception class for the Result::ErrorPermissionInsufficient aka XR_ERROR_PERMISSION_INSUFFICIENT result code.
class PermissionInsufficientError : public SystemError {
   public:
    PermissionInsufficientError (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPermissionInsufficient), message){}

    PermissionInsufficientError (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorPermissionInsufficient), message) {}
};
...
//! @brief Exception class for the Result::ErrorMarkerDetectorPermissionDeniedML aka XR_ERROR_MARKER_DETECTOR_PERMISSION_DENIED_ML result code.
class MarkerDetectorPermissionDeniedErrorML : public SystemError {
   public:
    MarkerDetectorPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorPermissionDeniedML), message){}

    MarkerDetectorPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorPermissionDeniedML), message) {}
};
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
//! @brief Exception class for the Result::ErrorMarkerDetectorLocateFailedML aka XR_ERROR_MARKER_DETECTOR_LOCATE_FAILED_ML result code.
class MarkerDetectorLocateFailedErrorML : public SystemError {
   public:
    MarkerDetectorLocateFailedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorLocateFailedML), message){}

    MarkerDetectorLocateFailedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorLocateFailedML), message) {}
};
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
//! @brief Exception class for the Result::ErrorMarkerDetectorInvalidDataQueryML aka XR_ERROR_MARKER_DETECTOR_INVALID_DATA_QUERY_ML result code.
class MarkerDetectorInvalidDataQueryErrorML : public SystemError {
   public:
    MarkerDetectorInvalidDataQueryErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidDataQueryML), message){}

    MarkerDetectorInvalidDataQueryErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidDataQueryML), message) {}
};
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
//! @brief Exception class for the Result::ErrorMarkerDetectorInvalidCreateInfoML aka XR_ERROR_MARKER_DETECTOR_INVALID_CREATE_INFO_ML result code.
class MarkerDetectorInvalidCreateInfoErrorML : public SystemError {
   public:
    MarkerDetectorInvalidCreateInfoErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidCreateInfoML), message){}

    MarkerDetectorInvalidCreateInfoErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerDetectorInvalidCreateInfoML), message) {}
};
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_marker_understanding
//! @brief Exception class for the Result::ErrorMarkerInvalidML aka XR_ERROR_MARKER_INVALID_ML result code.
class MarkerInvalidErrorML : public SystemError {
   public:
    MarkerInvalidErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerInvalidML), message){}

    MarkerInvalidErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorMarkerInvalidML), message) {}
};
#endif  // XR_ML_marker_understanding
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapIncompatibleML aka XR_ERROR_LOCALIZATION_MAP_INCOMPATIBLE_ML result code.
class LocalizationMapIncompatibleErrorML : public SystemError {
   public:
    LocalizationMapIncompatibleErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapIncompatibleML), message){}

    LocalizationMapIncompatibleErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapIncompatibleML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapUnavailableML aka XR_ERROR_LOCALIZATION_MAP_UNAVAILABLE_ML result code.
class LocalizationMapUnavailableErrorML : public SystemError {
   public:
    LocalizationMapUnavailableErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapUnavailableML), message){}

    LocalizationMapUnavailableErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapUnavailableML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapFailML aka XR_ERROR_LOCALIZATION_MAP_FAIL_ML result code.
class LocalizationMapFailErrorML : public SystemError {
   public:
    LocalizationMapFailErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapFailML), message){}

    LocalizationMapFailErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapFailML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapImportExportPermissionDeniedML aka XR_ERROR_LOCALIZATION_MAP_IMPORT_EXPORT_PERMISSION_DENIED_ML result code.
class LocalizationMapImportExportPermissionDeniedErrorML : public SystemError {
   public:
    LocalizationMapImportExportPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapImportExportPermissionDeniedML), message){}

    LocalizationMapImportExportPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapImportExportPermissionDeniedML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapPermissionDeniedML aka XR_ERROR_LOCALIZATION_MAP_PERMISSION_DENIED_ML result code.
class LocalizationMapPermissionDeniedErrorML : public SystemError {
   public:
    LocalizationMapPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapPermissionDeniedML), message){}

    LocalizationMapPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapPermissionDeniedML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapAlreadyExistsML aka XR_ERROR_LOCALIZATION_MAP_ALREADY_EXISTS_ML result code.
class LocalizationMapAlreadyExistsErrorML : public SystemError {
   public:
    LocalizationMapAlreadyExistsErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapAlreadyExistsML), message){}

    LocalizationMapAlreadyExistsErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapAlreadyExistsML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_localization_map
//! @brief Exception class for the Result::ErrorLocalizationMapCannotExportCloudMapML aka XR_ERROR_LOCALIZATION_MAP_CANNOT_EXPORT_CLOUD_MAP_ML result code.
class LocalizationMapCannotExportCloudMapErrorML : public SystemError {
   public:
    LocalizationMapCannotExportCloudMapErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapCannotExportCloudMapML), message){}

    LocalizationMapCannotExportCloudMapErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorLocalizationMapCannotExportCloudMapML), message) {}
};
#endif  // XR_ML_localization_map
#ifdef XR_ML_spatial_anchors
//! @brief Exception class for the Result::ErrorSpatialAnchorsPermissionDeniedML aka XR_ERROR_SPATIAL_ANCHORS_PERMISSION_DENIED_ML result code.
class SpatialAnchorsPermissionDeniedErrorML : public SystemError {
   public:
    SpatialAnchorsPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsPermissionDeniedML), message){}

    SpatialAnchorsPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsPermissionDeniedML), message) {}
};
#endif  // XR_ML_spatial_anchors
#ifdef XR_ML_spatial_anchors
//! @brief Exception class for the Result::ErrorSpatialAnchorsNotLocalizedML aka XR_ERROR_SPATIAL_ANCHORS_NOT_LOCALIZED_ML result code.
class SpatialAnchorsNotLocalizedErrorML : public SystemError {
   public:
    SpatialAnchorsNotLocalizedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsNotLocalizedML), message){}

    SpatialAnchorsNotLocalizedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsNotLocalizedML), message) {}
};
#endif  // XR_ML_spatial_anchors
#ifdef XR_ML_spatial_anchors
//! @brief Exception class for the Result::ErrorSpatialAnchorsOutOfMapBoundsML aka XR_ERROR_SPATIAL_ANCHORS_OUT_OF_MAP_BOUNDS_ML result code.
class SpatialAnchorsOutOfMapBoundsErrorML : public SystemError {
   public:
    SpatialAnchorsOutOfMapBoundsErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsOutOfMapBoundsML), message){}

    SpatialAnchorsOutOfMapBoundsErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsOutOfMapBoundsML), message) {}
};
#endif  // XR_ML_spatial_anchors
#ifdef XR_ML_spatial_anchors
//! @brief Exception class for the Result::ErrorSpatialAnchorsSpaceNotLocatableML aka XR_ERROR_SPATIAL_ANCHORS_SPACE_NOT_LOCATABLE_ML result code.
class SpatialAnchorsSpaceNotLocatableErrorML : public SystemError {
   public:
    SpatialAnchorsSpaceNotLocatableErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsSpaceNotLocatableML), message){}

    SpatialAnchorsSpaceNotLocatableErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsSpaceNotLocatableML), message) {}
};
#endif  // XR_ML_spatial_anchors
#ifdef XR_ML_spatial_anchors_storage
//! @brief Exception class for the Result::ErrorSpatialAnchorsAnchorNotFoundML aka XR_ERROR_SPATIAL_ANCHORS_ANCHOR_NOT_FOUND_ML result code.
class SpatialAnchorsAnchorNotFoundErrorML : public SystemError {
   public:
    SpatialAnchorsAnchorNotFoundErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsAnchorNotFoundML), message){}

    SpatialAnchorsAnchorNotFoundErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpatialAnchorsAnchorNotFoundML), message) {}
};
...
//! @brief Exception class for the Result::ErrorSpaceMappingInsufficientFB aka XR_ERROR_SPACE_MAPPING_INSUFFICIENT_FB result code.
class SpaceMappingInsufficientErrorFB : public SystemError {
   public:
    SpaceMappingInsufficientErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceMappingInsufficientFB), message){}

    SpaceMappingInsufficientErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceMappingInsufficientFB), message) {}
};
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
//! @brief Exception class for the Result::ErrorSpaceLocalizationFailedFB aka XR_ERROR_SPACE_LOCALIZATION_FAILED_FB result code.
class SpaceLocalizationFailedErrorFB : public SystemError {
   public:
    SpaceLocalizationFailedErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceLocalizationFailedFB), message){}

    SpaceLocalizationFailedErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceLocalizationFailedFB), message) {}
};
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
//! @brief Exception class for the Result::ErrorSpaceNetworkTimeoutFB aka XR_ERROR_SPACE_NETWORK_TIMEOUT_FB result code.
class SpaceNetworkTimeoutErrorFB : public SystemError {
   public:
    SpaceNetworkTimeoutErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNetworkTimeoutFB), message){}

    SpaceNetworkTimeoutErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNetworkTimeoutFB), message) {}
};
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
//! @brief Exception class for the Result::ErrorSpaceNetworkRequestFailedFB aka XR_ERROR_SPACE_NETWORK_REQUEST_FAILED_FB result code.
class SpaceNetworkRequestFailedErrorFB : public SystemError {
   public:
    SpaceNetworkRequestFailedErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNetworkRequestFailedFB), message){}

    SpaceNetworkRequestFailedErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNetworkRequestFailedFB), message) {}
};
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_FB_spatial_entity_sharing
//! @brief Exception class for the Result::ErrorSpaceCloudStorageDisabledFB aka XR_ERROR_SPACE_CLOUD_STORAGE_DISABLED_FB result code.
class SpaceCloudStorageDisabledErrorFB : public SystemError {
   public:
    SpaceCloudStorageDisabledErrorFB (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceCloudStorageDisabledFB), message){}

    SpaceCloudStorageDisabledErrorFB (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceCloudStorageDisabledFB), message) {}
};
#endif  // XR_FB_spatial_entity_sharing
#ifdef XR_META_passthrough_color_lut
//! @brief Exception class for the Result::ErrorPassthroughColorLutBufferSizeMismatchMETA aka XR_ERROR_PASSTHROUGH_COLOR_LUT_BUFFER_SIZE_MISMATCH_META result code.
class PassthroughColorLutBufferSizeMismatchErrorMETA : public SystemError {
   public:
    PassthroughColorLutBufferSizeMismatchErrorMETA (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPassthroughColorLutBufferSizeMismatchMETA), message){}

    PassthroughColorLutBufferSizeMismatchErrorMETA (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorPassthroughColorLutBufferSizeMismatchMETA), message) {}
};
#endif  // XR_META_passthrough_color_lut
#ifdef XR_QCOM_tracking_optimization_settings
//! @brief Exception class for the Result::ErrorHintAlreadySetQCOM aka XR_ERROR_HINT_ALREADY_SET_QCOM result code.
class HintAlreadySetErrorQCOM : public SystemError {
   public:
    HintAlreadySetErrorQCOM (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorHintAlreadySetQCOM), message){}

    HintAlreadySetErrorQCOM (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorHintAlreadySetQCOM), message) {}
};
#endif  // XR_QCOM_tracking_optimization_settings
#ifdef XR_HTC_anchor
//! @brief Exception class for the Result::ErrorNotAnAnchorHTC aka XR_ERROR_NOT_AN_ANCHOR_HTC result code.
class NotAnAnchorErrorHTC : public SystemError {
   public:
    NotAnAnchorErrorHTC (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorNotAnAnchorHTC), message){}

    NotAnAnchorErrorHTC (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorNotAnAnchorHTC), message) {}
};
#endif  // XR_HTC_anchor
#ifdef XR_EXT_plane_detection
//! @brief Exception class for the Result::ErrorSpaceNotLocatableEXT aka XR_ERROR_SPACE_NOT_LOCATABLE_EXT result code.
class SpaceNotLocatableErrorEXT : public SystemError {
   public:
    SpaceNotLocatableErrorEXT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNotLocatableEXT), message){}

    SpaceNotLocatableErrorEXT (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceNotLocatableEXT), message) {}
};
#endif  // XR_EXT_plane_detection
#ifdef XR_EXT_plane_detection
//! @brief Exception class for the Result::ErrorPlaneDetectionPermissionDeniedEXT aka XR_ERROR_PLANE_DETECTION_PERMISSION_DENIED_EXT result code.
class PlaneDetectionPermissionDeniedErrorEXT : public SystemError {
   public:
    PlaneDetectionPermissionDeniedErrorEXT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPlaneDetectionPermissionDeniedEXT), message){}

    PlaneDetectionPermissionDeniedErrorEXT (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorPlaneDetectionPermissionDeniedEXT), message) {}
};
#endif  // XR_EXT_plane_detection
#ifdef XR_EXT_future
//! @brief Exception class for the Result::ErrorFuturePendingEXT aka XR_ERROR_FUTURE_PENDING_EXT result code.
class FuturePendingErrorEXT : public SystemError {
   public:
    FuturePendingErrorEXT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorFuturePendingEXT), message){}

    FuturePendingErrorEXT (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorFuturePendingEXT), message) {}
};
#endif  // XR_EXT_future
#ifdef XR_EXT_future
//! @brief Exception class for the Result::ErrorFutureInvalidEXT aka XR_ERROR_FUTURE_INVALID_EXT result code.
class FutureInvalidErrorEXT : public SystemError {
   public:
    FutureInvalidErrorEXT (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorFutureInvalidEXT), message){}

    FutureInvalidErrorEXT (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorFutureInvalidEXT), message) {}
};
#endif  // XR_EXT_future
#ifdef XR_ML_system_notifications
//! @brief Exception class for the Result::ErrorSystemNotificationPermissionDeniedML aka XR_ERROR_SYSTEM_NOTIFICATION_PERMISSION_DENIED_ML result code.
class SystemNotificationPermissionDeniedErrorML : public SystemError {
   public:
    SystemNotificationPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationPermissionDeniedML), message){}

    SystemNotificationPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationPermissionDeniedML), message) {}
};
#endif  // XR_ML_system_notifications
#ifdef XR_ML_system_notifications
//! @brief Exception class for the Result::ErrorSystemNotificationIncompatibleSkuML aka XR_ERROR_SYSTEM_NOTIFICATION_INCOMPATIBLE_SKU_ML result code.
class SystemNotificationIncompatibleSkuErrorML : public SystemError {
   public:
    SystemNotificationIncompatibleSkuErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationIncompatibleSkuML), message){}

    SystemNotificationIncompatibleSkuErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSystemNotificationIncompatibleSkuML), message) {}
};
#endif  // XR_ML_system_notifications
#ifdef XR_ML_world_mesh_detection
//! @brief Exception class for the Result::ErrorWorldMeshDetectorPermissionDeniedML aka XR_ERROR_WORLD_MESH_DETECTOR_PERMISSION_DENIED_ML result code.
class WorldMeshDetectorPermissionDeniedErrorML : public SystemError {
   public:
    WorldMeshDetectorPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorPermissionDeniedML), message){}

    WorldMeshDetectorPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorPermissionDeniedML), message) {}
};
#endif  // XR_ML_world_mesh_detection
#ifdef XR_ML_world_mesh_detection
//! @brief Exception class for the Result::ErrorWorldMeshDetectorSpaceNotLocatableML aka XR_ERROR_WORLD_MESH_DETECTOR_SPACE_NOT_LOCATABLE_ML result code.
class WorldMeshDetectorSpaceNotLocatableErrorML : public SystemError {
   public:
    WorldMeshDetectorSpaceNotLocatableErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorSpaceNotLocatableML), message){}

    WorldMeshDetectorSpaceNotLocatableErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorWorldMeshDetectorSpaceNotLocatableML), message) {}
};
#endif  // XR_ML_world_mesh_detection
#ifdef XR_ML_facial_expression
//! @brief Exception class for the Result::ErrorFacialExpressionPermissionDeniedML aka XR_ERROR_FACIAL_EXPRESSION_PERMISSION_DENIED_ML result code.
class FacialExpressionPermissionDeniedErrorML : public SystemError {
   public:
    FacialExpressionPermissionDeniedErrorML (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorFacialExpressionPermissionDeniedML), message){}

    FacialExpressionPermissionDeniedErrorML (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorFacialExpressionPermissionDeniedML), message) {}
};
#endif  // XR_ML_facial_expression
#ifdef XR_META_colocation_discovery
//! @brief Exception class for the Result::ErrorColocationDiscoveryNetworkFailedMETA aka XR_ERROR_COLOCATION_DISCOVERY_NETWORK_FAILED_META result code.
class ColocationDiscoveryNetworkFailedErrorMETA : public SystemError {
   public:
    ColocationDiscoveryNetworkFailedErrorMETA (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNetworkFailedMETA), message){}

    ColocationDiscoveryNetworkFailedErrorMETA (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNetworkFailedMETA), message) {}
};
#endif  // XR_META_colocation_discovery
#ifdef XR_META_colocation_discovery
//! @brief Exception class for the Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA aka XR_ERROR_COLOCATION_DISCOVERY_NO_DISCOVERY_METHOD_META result code.
class ColocationDiscoveryNoDiscoveryMethodErrorMETA : public SystemError {
   public:
    ColocationDiscoveryNoDiscoveryMethodErrorMETA (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA), message){}

    ColocationDiscoveryNoDiscoveryMethodErrorMETA (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA), message) {}
};
#endif  // XR_META_colocation_discovery
#ifdef XR_META_spatial_entity_group_sharing
//! @brief Exception class for the Result::ErrorSpaceGroupNotFoundMETA aka XR_ERROR_SPACE_GROUP_NOT_FOUND_META result code.
class SpaceGroupNotFoundErrorMETA : public SystemError {
   public:
    SpaceGroupNotFoundErrorMETA (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceGroupNotFoundMETA), message){}

    SpaceGroupNotFoundErrorMETA (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceGroupNotFoundMETA), message) {}
};
#endif  // XR_META_spatial_entity_group_sharing
#ifdef XR_KHR_maintenance1
//! @brief Exception class for the Result::ErrorExtensionDependencyNotEnabledKHR aka XR_ERROR_EXTENSION_DEPENDENCY_NOT_ENABLED_KHR result code.
class ExtensionDependencyNotEnabledErrorKHR : public SystemError {
   public:
    ExtensionDependencyNotEnabledErrorKHR (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorExtensionDependencyNotEnabledKHR), message){}

    ExtensionDependencyNotEnabledErrorKHR (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorExtensionDependencyNotEnabledKHR), message) {}
};
#endif  // XR_KHR_maintenance1
#ifdef XR_KHR_maintenance1
//! @brief Exception class for the Result::ErrorPermissionInsufficientKHR aka XR_ERROR_PERMISSION_INSUFFICIENT_KHR result code.
class PermissionInsufficientErrorKHR : public SystemError {
   public:
    PermissionInsufficientErrorKHR (std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorPermissionInsufficientKHR), message){}

    PermissionInsufficientErrorKHR (char const* message)
        : SystemError(impl::make_error_code(Result::ErrorPermissionInsufficientKHR), message) {}
};
#endif  // XR_KHR_maintenance1
...
OPENXR_HPP_INLINE void throwResultException(Result result, char const* message) {
    switch (result) {
        ...
        case Result::ErrorExtensionDependencyNotEnabled:
            throw ExtensionDependencyNotEnabledError (message);
            

        
        case Result::ErrorPermissionInsufficient:
            throw PermissionInsufficientError (message);
        ...
        case Result::ErrorMarkerDetectorPermissionDeniedML:
            throw MarkerDetectorPermissionDeniedErrorML (message);
            #endif  // XR_ML_marker_understanding

        #ifdef XR_ML_marker_understanding
        case Result::ErrorMarkerDetectorLocateFailedML:
            throw MarkerDetectorLocateFailedErrorML (message);
            #endif  // XR_ML_marker_understanding

        #ifdef XR_ML_marker_understanding
        case Result::ErrorMarkerDetectorInvalidDataQueryML:
            throw MarkerDetectorInvalidDataQueryErrorML (message);
            #endif  // XR_ML_marker_understanding

        #ifdef XR_ML_marker_understanding
        case Result::ErrorMarkerDetectorInvalidCreateInfoML:
            throw MarkerDetectorInvalidCreateInfoErrorML (message);
            #endif  // XR_ML_marker_understanding

        #ifdef XR_ML_marker_understanding
        case Result::ErrorMarkerInvalidML:
            throw MarkerInvalidErrorML (message);
            #endif  // XR_ML_marker_understanding

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapIncompatibleML:
            throw LocalizationMapIncompatibleErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapUnavailableML:
            throw LocalizationMapUnavailableErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapFailML:
            throw LocalizationMapFailErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapImportExportPermissionDeniedML:
            throw LocalizationMapImportExportPermissionDeniedErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapPermissionDeniedML:
            throw LocalizationMapPermissionDeniedErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapAlreadyExistsML:
            throw LocalizationMapAlreadyExistsErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_localization_map
        case Result::ErrorLocalizationMapCannotExportCloudMapML:
            throw LocalizationMapCannotExportCloudMapErrorML (message);
            #endif  // XR_ML_localization_map

        #ifdef XR_ML_spatial_anchors
        case Result::ErrorSpatialAnchorsPermissionDeniedML:
            throw SpatialAnchorsPermissionDeniedErrorML (message);
            #endif  // XR_ML_spatial_anchors

        #ifdef XR_ML_spatial_anchors
        case Result::ErrorSpatialAnchorsNotLocalizedML:
            throw SpatialAnchorsNotLocalizedErrorML (message);
            #endif  // XR_ML_spatial_anchors

        #ifdef XR_ML_spatial_anchors
        case Result::ErrorSpatialAnchorsOutOfMapBoundsML:
            throw SpatialAnchorsOutOfMapBoundsErrorML (message);
            #endif  // XR_ML_spatial_anchors

        #ifdef XR_ML_spatial_anchors
        case Result::ErrorSpatialAnchorsSpaceNotLocatableML:
            throw SpatialAnchorsSpaceNotLocatableErrorML (message);
            #endif  // XR_ML_spatial_anchors

        #ifdef XR_ML_spatial_anchors_storage
        case Result::ErrorSpatialAnchorsAnchorNotFoundML:
            throw SpatialAnchorsAnchorNotFoundErrorML (message);
            #endif  // XR_ML_spatial_anchors_storage
        ...
        case Result::ErrorSpaceMappingInsufficientFB:
            throw SpaceMappingInsufficientErrorFB (message);
            #endif  // XR_FB_spatial_entity_sharing

        #ifdef XR_FB_spatial_entity_sharing
        case Result::ErrorSpaceLocalizationFailedFB:
            throw SpaceLocalizationFailedErrorFB (message);
            #endif  // XR_FB_spatial_entity_sharing

        #ifdef XR_FB_spatial_entity_sharing
        case Result::ErrorSpaceNetworkTimeoutFB:
            throw SpaceNetworkTimeoutErrorFB (message);
            #endif  // XR_FB_spatial_entity_sharing

        #ifdef XR_FB_spatial_entity_sharing
        case Result::ErrorSpaceNetworkRequestFailedFB:
            throw SpaceNetworkRequestFailedErrorFB (message);
            #endif  // XR_FB_spatial_entity_sharing

        #ifdef XR_FB_spatial_entity_sharing
        case Result::ErrorSpaceCloudStorageDisabledFB:
            throw SpaceCloudStorageDisabledErrorFB (message);
            #endif  // XR_FB_spatial_entity_sharing

        #ifdef XR_META_passthrough_color_lut
        case Result::ErrorPassthroughColorLutBufferSizeMismatchMETA:
            throw PassthroughColorLutBufferSizeMismatchErrorMETA (message);
            #endif  // XR_META_passthrough_color_lut
        ...
        case Result::ErrorHintAlreadySetQCOM:
            throw HintAlreadySetErrorQCOM (message);
            #endif  // XR_QCOM_tracking_optimization_settings

        #ifdef XR_HTC_anchor
        case Result::ErrorNotAnAnchorHTC:
            throw NotAnAnchorErrorHTC (message);
            #endif  // XR_HTC_anchor

        #ifdef XR_EXT_plane_detection
        case Result::ErrorSpaceNotLocatableEXT:
            throw SpaceNotLocatableErrorEXT (message);
            #endif  // XR_EXT_plane_detection

        #ifdef XR_EXT_plane_detection
        case Result::ErrorPlaneDetectionPermissionDeniedEXT:
            throw PlaneDetectionPermissionDeniedErrorEXT (message);
            #endif  // XR_EXT_plane_detection

        #ifdef XR_EXT_future
        case Result::ErrorFuturePendingEXT:
            throw FuturePendingErrorEXT (message);
            #endif  // XR_EXT_future

        #ifdef XR_EXT_future
        case Result::ErrorFutureInvalidEXT:
            throw FutureInvalidErrorEXT (message);
            #endif  // XR_EXT_future

        #ifdef XR_ML_system_notifications
        case Result::ErrorSystemNotificationPermissionDeniedML:
            throw SystemNotificationPermissionDeniedErrorML (message);
            #endif  // XR_ML_system_notifications

        #ifdef XR_ML_system_notifications
        case Result::ErrorSystemNotificationIncompatibleSkuML:
            throw SystemNotificationIncompatibleSkuErrorML (message);
            #endif  // XR_ML_system_notifications

        #ifdef XR_ML_world_mesh_detection
        case Result::ErrorWorldMeshDetectorPermissionDeniedML:
            throw WorldMeshDetectorPermissionDeniedErrorML (message);
            #endif  // XR_ML_world_mesh_detection

        #ifdef XR_ML_world_mesh_detection
        case Result::ErrorWorldMeshDetectorSpaceNotLocatableML:
            throw WorldMeshDetectorSpaceNotLocatableErrorML (message);
            #endif  // XR_ML_world_mesh_detection

        #ifdef XR_ML_facial_expression
        case Result::ErrorFacialExpressionPermissionDeniedML:
            throw FacialExpressionPermissionDeniedErrorML (message);
            #endif  // XR_ML_facial_expression

        #ifdef XR_META_colocation_discovery
        case Result::ErrorColocationDiscoveryNetworkFailedMETA:
            throw ColocationDiscoveryNetworkFailedErrorMETA (message);
            #endif  // XR_META_colocation_discovery

        #ifdef XR_META_colocation_discovery
        case Result::ErrorColocationDiscoveryNoDiscoveryMethodMETA:
            throw ColocationDiscoveryNoDiscoveryMethodErrorMETA (message);
            #endif  // XR_META_colocation_discovery
        ...
        case Result::ErrorSpaceGroupNotFoundMETA:
            throw SpaceGroupNotFoundErrorMETA (message);
            #endif  // XR_META_spatial_entity_group_sharing

        #ifdef XR_KHR_maintenance1
        case Result::ErrorExtensionDependencyNotEnabledKHR:
            throw ExtensionDependencyNotEnabledErrorKHR (message);
            #endif  // XR_KHR_maintenance1

        #ifdef XR_KHR_maintenance1
        case Result::ErrorPermissionInsufficientKHR:
            throw PermissionInsufficientErrorKHR (message);
            #endif  // XR_KHR_maintenance1
