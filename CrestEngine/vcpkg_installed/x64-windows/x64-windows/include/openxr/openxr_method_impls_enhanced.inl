...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<NegotiateRuntimeRequest> negotiateLoaderRuntimeInterface (
    ...
    return { result, std::move(runtimeRequest) };
}
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<NegotiateApiLayerRequest> negotiateLoaderApiLayerInterface (
    ...
    return { result, std::move(apiLayerRequest) };
}
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpaceLocations> Session::locateSpaces (
    ...
    return { result, std::move(spaceLocations) };
}
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<GraphicsRequirementsMetalKHR> Instance::getMetalGraphicsRequirementsKHR (
    SystemId systemId, Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpaceLocations> Session::locateSpacesKHR (
    const SpacesLocateInfo& locateInfo, Dispatch&& d) const {
    SpaceLocations spaceLocations;
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<CreateSpatialAnchorsCompletionML> Session::createSpatialAnchorsCompleteML (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpatialAnchorsQueryCompletionML> SpatialAnchorsStorageML::querySpatialAnchorsCompleteML (
    XrFutureEXT future, Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpatialAnchorsPublishCompletionML> SpatialAnchorsStorageML::publishSpatialAnchorsCompleteML (
    XrFutureEXT future, Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpaceTriangleMeshMETA> Space::getSpaceTriangleMeshMETA (
    ...
    return { result, std::move(triangleMeshOutput) };
}
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<FaceExpressionWeights2FB> FaceTracker2FB::getFaceExpressionWeights2FB (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Allocator, typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<std::vector<SwapchainImageBaseHeader, Allocator>> EnvironmentDepthSwapchainMETA::enumerateEnvironmentDepthSwapchainImagesToVectorMETA (
    Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<BodyJointLocationsHTC> BodyTrackerHTC::locateBodyJointsHTC (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<BodySkeletonHTC> BodyTrackerHTC::getBodySkeletonHTC (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<BodyJointLocationsBD> BodyTrackerBD::locateBodyJointsBD (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<WorldMeshStateRequestCompletionML> WorldMeshDetectorML::requestWorldMeshStateCompleteML (
    XrFutureEXT future, Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<WorldMeshBufferML> WorldMeshDetectorML::allocateWorldMeshBufferML (
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<WorldMeshRequestCompletionML> WorldMeshDetectorML::requestWorldMeshCompleteML (
